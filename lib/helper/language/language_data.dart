import 'package:el_mola/services/local_storage/local_storage.dart';
...
class LanguageData {
  ...
  static var selectedLanguageIndex = languageList().where((element) => element.languageCode == (LocalStorage.languageCode)).first;
