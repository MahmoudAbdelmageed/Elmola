...
class LocalStorage {
  ...
  static const String loggedInType = 'type';
  ...
  static init() async {
    ...
    if (GetStorage().read(languageKey) == null) {
      // String langCode = 'ar';
      String langCode = (Get.deviceLocale?.languageCode ?? 'ar');
  ...
  static String get loginType => GetStorage().read(loggedInType)?? "user";

  static String get languageCode => GetStorage().read(languageKey) ?? 'ar';
